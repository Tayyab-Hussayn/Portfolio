        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-8">
            ...
            >
              ...
              <div 
                v-show="isStudioOpen"
                class="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-[700px] bg-[#F3F0F8]/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 overflow-hidden transition-all duration-300 transform origin-top ring-1 ring-black/5"
